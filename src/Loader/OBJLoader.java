...
public class OBJLoader {
	...
	public static RawModel loadObjModel(String fileName) {
		...
		return VAOLoader.loadToVAO(verticesArray, texturesArray, normalsArray, indicesArray);
	}
	...
	private static void processVertex(String [] vertexData, List<Integer>indices, 
		...
		Vector2f texture = textures.get(Integer.parseInt(vertexData[1]) - 1);
		texturesArray[currentVertexPointer * 2] = texture.x;
		texturesArray[currentVertexPointer * 2 + 1] = 1 - texture.y;
